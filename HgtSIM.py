...
# HgtSIM is free software: you can redistribute it and/or modify it under the terms of
# the GNU Affero General Public License as published by the Free Software Foundation,
# either version 3 of the License, or (at your option) any later version.

# HgtSIM is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY;
...
parser.add_argument('-t',
                    required=True,
                    help='sequences of genes to be transferred (multi-fasta format)')
...
parser.add_argument('-f',
                    required=True,
                    help='folder holds recipient genomes')
...
parser.add_argument('-x',
                    required=False,
                    default='fna',
                    help='file extension of recipient genomes')

parser.add_argument('-lf',
                    required=False,
                    default='',
                    help='left end flanking sequences')
...
parser.add_argument('-keep_cds',
                    action="store_true",
                    required=False,
                    help='insert transfers only to non-coding regions, need the annotation files (in gbk format) of recipient genomes')

parser.add_argument('-a',
                    required=False,
                    help='folder holds the annotation files (in gbk format) of recipient genomes')
